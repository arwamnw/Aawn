...
public class Phrase2 extends Activity implements OnTouchListener, OnDragListener {
    private static final String LOGCAT = null;
    TextView firstWord;
    TextView secondWord, thirdWord;
    Button btn;
    LinearLayout first, second, third;
    String RIGTH_WORD_1 = "يقرأ";
    String RIGTH_WORD_2 = "أحمد";
    String RIGTH_WORD_3 = "قصة";
    int child_id;
    String game_type;
    String game_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phrase2);
        ...
        firstWord = findViewById(R.id.ahmed);
        findViewById(R.id.ahmed).setOnTouchListener(this);
        findViewById(R.id.layout1).setOnDragListener(this);
        findViewById(R.id.cv1).setOnDragListener(this);
        secondWord = findViewById(R.id.read);
        findViewById(R.id.read).setOnTouchListener(this);
        findViewById(R.id.layout3).setOnDragListener(this);
        findViewById(R.id.cv2).setOnDragListener(this);
        thirdWord = findViewById(R.id.story);
        findViewById(R.id.story).setOnTouchListener(this);
            ...
            if (RIGTH_WORD_1.equals(firstWord)) {
                if (RIGTH_WORD_2.equals(secWord)) {
                    if (RIGTH_WORD_3.equals(thirdWord)) {
                        ...
                        Intent i=new Intent(Phrase2.this, Phrase2Win.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
                        startActivity(i);
                    } else {
                        result.put("game_result", String.valueOf(0));
                        Intent i=new Intent(Phrase2.this, Phrase2Fail.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);

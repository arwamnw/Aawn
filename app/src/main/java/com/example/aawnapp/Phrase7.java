...
public class Phrase7 extends Activity implements OnTouchListener, OnDragListener {
    private static final String LOGCAT = null;
    TextView firstWord;
    TextView secondWord, thirdWord;
    Button btn;
    LinearLayout first, second, third;
    String RIGTH_WORD_1 = "زار";
    String RIGTH_WORD_2 = "أبي";
    String RIGTH_WORD_3 = "صديقه";
    int child_id;
    String game_type;
    String game_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phrase7);
        ...
        firstWord = findViewById(R.id.write);
        findViewById(R.id.write).setOnTouchListener(this);
        findViewById(R.id.layout1).setOnDragListener(this);
        findViewById(R.id.cv1).setOnDragListener(this);
        secondWord = findViewById(R.id.student);
        findViewById(R.id.student).setOnTouchListener(this);
        findViewById(R.id.layout3).setOnDragListener(this);
        findViewById(R.id.cv2).setOnDragListener(this);
        thirdWord = findViewById(R.id.lesson);
        findViewById(R.id.lesson).setOnTouchListener(this);
            ...
            if (RIGTH_WORD_1.equals(firstWord)) {
                if (RIGTH_WORD_2.equals(secWord)) {
                    if (RIGTH_WORD_3.equals(thirdWord)) {
                        ...
                        Intent i=new Intent(Phrase7.this, Phrase7Win.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
                        startActivity(i);
                    } else {
                        result.put("game_result", String.valueOf(0));
                        Intent i=new Intent(Phrase7.this, Phrase7Fail.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
                    ...
                    result.put("game_result", String.valueOf(0));
                    startActivity(new Intent(Phrase7.this, Phrase7Fail.class));Intent i=new Intent(Phrase7.this, Phrase7Fail.class);
                    i.putExtra("child_id",child_id);
                    i.putExtra("game_type",game_type);
                    i.putExtra("game_name",game_name);
                    startActivity(i);

...
public class Phrase8 extends Activity implements OnTouchListener, OnDragListener {
    private static final String LOGCAT = null;
    TextView firstWord;
    TextView secondWord, thirdWord;
    Button btn;
    LinearLayout first, second, third;
    String RIGTH_WORD_1 = "أكل";
    String RIGTH_WORD_2 = "أخي";
    String RIGTH_WORD_3 = "الطعام";
    int child_id;
    String game_type;
    String game_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phrase8);
        ...
        firstWord = findViewById(R.id.eat);
        findViewById(R.id.eat).setOnTouchListener(this);
        findViewById(R.id.layout1).setOnDragListener(this);
        findViewById(R.id.cv1).setOnDragListener(this);
        secondWord = findViewById(R.id.brother);
        findViewById(R.id.brother).setOnTouchListener(this);
        findViewById(R.id.layout3).setOnDragListener(this);
        findViewById(R.id.cv2).setOnDragListener(this);
        thirdWord = findViewById(R.id.food);
        findViewById(R.id.food).setOnTouchListener(this);
            ...
            if (RIGTH_WORD_1.equals(firstWord)) {
                if (RIGTH_WORD_2.equals(secWord)) {
                    if (RIGTH_WORD_3.equals(thirdWord)) {
                        ...
                        Intent i=new Intent(Phrase8.this, Phrase8Win.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
                        startActivity(i);
                    } else {
                        result.put("game_result", String.valueOf(0));
                        Intent i=new Intent(Phrase8.this, Phrase8Fail.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);

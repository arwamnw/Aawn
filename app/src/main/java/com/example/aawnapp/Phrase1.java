...
public class Phrase1 extends Activity implements OnTouchListener, OnDragListener {
    ...
    String RIGTH_WORD_2 = "الطفل";
    String RIGTH_WORD_3 = "التفاح";
    int child_id;
    String game_type;
    String game_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secondWord = findViewById(R.id.apple);
        findViewById(R.id.apple).setOnTouchListener(this);
        findViewById(R.id.layout3).setOnDragListener(this);
        findViewById(R.id.cv2).setOnDragListener(this);
        thirdWord = findViewById(R.id.child);
        findViewById(R.id.child).setOnTouchListener(this);
            ...
            if (RIGTH_WORD_1.equals(firstWord)) {
                if (RIGTH_WORD_2.equals(secWord)) {
                    if (RIGTH_WORD_3.equals(thirdWord)) {
                        ...
                        Intent i=new Intent(Phrase1.this, Phrase1Win.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
                        startActivity(i);
                    } else {
                        result.put("game_result", String.valueOf(0));
                        Intent i=new Intent(Phrase1.this, Phrase1Fail.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);

...
public class Phrase6 extends Activity implements OnTouchListener, OnDragListener {
    private static final String LOGCAT = null;
    TextView firstWord;
    TextView secondWord, thirdWord;
    Button btn;
    LinearLayout first, second, third;
    String RIGTH_WORD_1 = "يكتب";
    String RIGTH_WORD_2 = "الطالب";
    String RIGTH_WORD_3 = "الدرس";
    int child_id;
    String game_type;
    String game_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phrase6);
            ...
            if (RIGTH_WORD_1.equals(firstWord)) {
                if (RIGTH_WORD_2.equals(secWord)) {
                    if (RIGTH_WORD_3.equals(thirdWord)) {
                        ...
                        Intent i=new Intent(Phrase6.this, Phrase6Win.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
                        startActivity(i);
                    } else {
                        result.put("game_result", String.valueOf(0));
                        Intent i=new Intent(Phrase6.this, Phrase6Fail.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);

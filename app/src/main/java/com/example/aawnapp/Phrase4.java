...
public class Phrase4 extends Activity implements OnTouchListener, OnDragListener {
    private static final String LOGCAT = null;
    TextView firstWord;
    TextView secondWord, thirdWord;
    Button btn;
    LinearLayout first, second, third;
    String RIGTH_WORD_1 = "يلعب";
    String RIGTH_WORD_2 = "مهند";
    String RIGTH_WORD_3 = "بالكرة";
    int child_id;
    String game_type;
    String game_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phrase4);
        ...
        firstWord = findViewById(R.id.play);
        ...
        secondWord = findViewById(R.id.muhannad);
        findViewById(R.id.muhannad).setOnTouchListener(this);
        findViewById(R.id.layout3).setOnDragListener(this);
        findViewById(R.id.cv2).setOnDragListener(this);
        thirdWord = findViewById(R.id.ball);
        findViewById(R.id.ball).setOnTouchListener(this);
            ...
            if (RIGTH_WORD_1.equals(firstWord)) {
                if (RIGTH_WORD_2.equals(secWord)) {
                    if (RIGTH_WORD_3.equals(thirdWord)) {
                        ...
                        Intent i=new Intent(Phrase4.this, Phrase4Win.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
                        startActivity(i);
                    } else {
                        result.put("game_result", String.valueOf(0));
                        Intent i=new Intent(Phrase4.this, Phrase4Fail.class);
                        i.putExtra("child_id",child_id);
                        i.putExtra("game_type",game_type);
